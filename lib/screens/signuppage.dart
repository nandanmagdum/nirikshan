...
class SignUpPage extends StatelessWidget {
  ...
  final TextEditingController _passwaordcontroller = TextEditingController();
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              } else if (_passwaordcontroller.text.length < 8) {
                                ScaffoldMessenger.of(context)
                                    .showSnackBar(const SnackBar(
                                  content: Text("Password is too short"),
                                ));
                              } else {
                                User? result = await Auth_Service().register(
